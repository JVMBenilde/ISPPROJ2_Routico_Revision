...
const AdministratorDashboard = () => {
  ...
  return (
    <div className="min-h-screen flex overflow-hidden bg-[#111621]">
      {/* Mobile Backdrop */}
      {sidebarOpen && (
      ...
      {/* Sidebar */}
      <div className={`fixed inset-y-0 left-0 z-[70] w-64 transform transition-transform duration-300 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:static md:z-auto md:translate-x-0 md:w-auto md:transform-none md:transition-[width] md:duration-300 ${sidebarOpen ? 'md:w-64' : 'md:w-20'} bg-slate-900 border-r border-slate-800 flex flex-col h-screen overflow-hidden`}>
        {/* Sidebar Header - Logo */}
      ...
      {/* Main Content Area */}
      <div className="flex-1 flex flex-col min-h-screen bg-[#111621] min-w-0 overflow-x-hidden">
        {/* Inline Header / Topbar */}
        <div className="h-16 border-b border-slate-800 bg-slate-900 px-4 md:px-6 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-3">
            {/* Mobile hamburger */}
            <button
              onClick={() => setSidebarOpen(!sidebarOpen)}
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-32 sm:w-44 md:w-56 pl-9 pr-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-sm text-slate-300 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
              {searchQuery && (
            ...
            <div className="relative" ref={notificationRef}>
              ...
              {showNotifications && (
                <div className="absolute right-0 top-full mt-2 w-72 sm:w-80 bg-slate-800 border border-slate-700 rounded-xl shadow-2xl z-50">
                      ...
                      <div className="px-6 py-5">
                        ...
                        <div className="space-y-3">
                          ...
                          {pendingUsers.map((pendingUser) => (
                            <div key={pendingUser.user_id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 py-3 px-4 rounded-xl bg-slate-800/50 border border-slate-800">
                              <div className="flex items-center gap-3 min-w-0">
                                <div className="h-10 w-10 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-full flex items-center justify-center border border-slate-700 flex-shrink-0">
